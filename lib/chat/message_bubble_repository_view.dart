...
Future<void> applyMessageBubbleRepositoryPhoto(
  ...
  if (!isEligibleMessageBubbleRepositoryPhoto(message)) {
    showToast(context, 'Bubble images must be exactly 160 × 120 px.');
    return;
  }
  ...
  try {
    ...
    final text = switch (error.failure) {
      CustomMessageBubbleImportFailure.wrongRepositorySize =>
        'Bubble images must be exactly 160 × 120 px.',
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'Repository images are exactly 160 × 120 px. The four center squares store text colors; color 1 is currently used.',
                  style: TextStyle(
